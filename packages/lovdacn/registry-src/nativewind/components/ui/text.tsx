  ...
  ),
  {
    variants: {
      variant: {
        ...
        h3: cn('font-heading text-2xl font-semibold tracking-tight', Platform.select({ web: 'scroll-m-20' })),
        h4: cn('font-heading text-xl font-semibold tracking-tight', Platform.select({ web: 'scroll-m-20' })),
