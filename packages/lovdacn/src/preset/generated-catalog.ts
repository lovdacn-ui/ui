...
export const WIRE_VERSION_V1 = "a" as const
export const WIRE_VERSION_V2 = "b" as const
...
export const PRESET_CHART_COLORS = [
  "neutral",
  "stone",
  "zinc",
  "gray",
...
export const PRESET_FONT_HEADINGS = [
  "inherit",
  "inter",
  "noto-sans",
  "nunito-sans",
...
export const PRESET_MENU_ACCENTS = [
  "subtle",
  "bold"
] as const
...
export const FONT_PACKAGES: Record<PresetFont, string> = {
  ...
  "noto-sans": "@expo-google-fonts/noto-sans@0.4.2",
  "geist-mono": "@expo-google-fonts/geist-mono@0.4.3",
  "oxanium": "@expo-google-fonts/oxanium@0.4.2",
  "ibm-plex-sans": "@expo-google-fonts/ibm-plex-sans@0.4.1",
  "eb-garamond": "@expo-google-fonts/eb-garamond@0.4.3"
}
export const ICON_PACKAGE_DEPENDENCIES: Record<PresetIconLibrary, readonly string[]> = {
  "lucide": [
...
export const ICON_IMPORTS: Record<PresetIconLibrary, string> = {
  ...
  "hugeicons": "@hugeicons/react-native",
  "tabler": "@tabler/icons-react-native",
  "phosphor": "phosphor-react-native",
  "remixicon": "react-native-remix-icon",
...
export const ICON_LIBRARY_CAPABILITIES: Record<PresetIconLibrary, IconLibraryCapability> = {
  "lucide": {
    "status": "supported"
  },
  "hugeicons": {
...
export const EFFECTIVE_RADIUS_DEFAULTS: Readonly<Partial<Record<PresetStyle, PresetRadius>>> = {
  "lyra": "none",
  "sera": "none"
}
export const FONT_MANIFEST = {
  ...
  "geist-mono": {
    ...
    "family": "Geist Mono",
    "category": "mono",
    "package": "@expo-google-fonts/geist-mono",
    "version": "0.4.3",
    "fallback": "ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace",
    "availableWeights": [
      400,
  ...
  "oxanium": {
    ...
    "family": "Oxanium",
    "category": "sans",
    "package": "@expo-google-fonts/oxanium",
    "version": "0.4.2",
    "fallback": "ui-sans-serif, system-ui, sans-serif",
    "availableWeights": [
      400,
  ...
  "ibm-plex-sans": {
    ...
    "category": "sans",
    "package": "@expo-google-fonts/ibm-plex-sans",
    "version": "0.4.1",
    "fallback": "ui-sans-serif, system-ui, sans-serif",
    "availableWeights": [
      400,
  ...
  "eb-garamond": {
    ...
    "family": "EB Garamond",
    "category": "serif",
    "package": "@expo-google-fonts/eb-garamond",
    "version": "0.4.3",
    "fallback": "Georgia, 'Times New Roman', serif",
    "availableWeights": [
      400,
...
export const ICON_LIBRARY_MANIFEST = {
  ...
  "hugeicons": {
    "label": "Hugeicons",
    "adapter": "hugeicons-data",
    "packages": [
      {
        "package": "@hugeicons/react-native",
        "version": "1.0.16"
      },
      {
    ...
    "glyphImport": "@hugeicons/core-free-icons"
  },
  "tabler": {
    "label": "Tabler",
    "adapter": "component",
    ...
    "import": "@tabler/icons-react-native"
  },
  "phosphor": {
    "label": "Phosphor",
    "adapter": "component",
  ...
  "remixicon": {
    "label": "Remix Icon",
    "adapter": "remix-string",
    "packages": [
      {
        "package": "react-native-remix-icon",
        "version": "4.7.0"
      }
    ],
    "import": "react-native-remix-icon",
    "capability": {
      "status": "supported"
    }
  },
...
export const SHADCN_DEFAULT_PRESETS: Record<PresetStyle, NamedPreset> = {
  "nova": {
    "title": "Nova",
    "description": "Lucide / Geist / Compact, restrained, tight cards",
    "style": "nova",
    "baseColor": "neutral",
    "theme": "neutral",
    "chartColor": "neutral",
  ...
  "vega": {
    "title": "Vega",
    "description": "Lucide / Inter / Balanced, classic default",
    "style": "vega",
    "baseColor": "neutral",
    "theme": "neutral",
    "chartColor": "neutral",
  ...
  "maia": {
    "title": "Maia",
    "description": "Hugeicons / Figtree / Spacious and strongly rounded",
    "style": "maia",
    "baseColor": "neutral",
    "theme": "neutral",
    "chartColor": "neutral",
  ...
  "mira": {
    "title": "Mira",
    "description": "Hugeicons / Inter / Dense, compact controls and type",
    "style": "mira",
    "baseColor": "neutral",
    "theme": "neutral",
    "chartColor": "neutral",
  ...
  "sera": {
    "title": "Sera",
    "description": "Lucide / Noto Sans + Playfair Display / Editorial, square, uppercase accents",
    "style": "sera",
    "baseColor": "taupe",
    "theme": "taupe",
    "chartColor": "taupe",
  ...
  "rhea": {
    "title": "Rhea",
    "description": "Lucide / Inter / Soft, pill-oriented, approachable",
    "style": "rhea",
    "baseColor": "neutral",
    "theme": "neutral",
    "chartColor": "neutral",
...
export const LVCN_LEGACY_PRESETS: Record<PresetStyle, NamedPreset> = {
  "luma": {
    "title": "Luma",
    "description": "Lucide / Inter / Soft, rounded, comfortable",
    "style": "luma",
